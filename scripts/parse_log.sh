...
grep 'Test net output #2' aux.txt | awk '{print $11}' > aux6.txt
...
# Generating
echo '#Iters Seconds TestAccuracyAt1 TestAccuracyAt5 TestLoss'> $LOG.test
paste aux0.txt aux4.txt aux1.txt aux2.txt aux6.txt| column -t >> $LOG.test
rm aux.txt aux0.txt aux1.txt aux2.txt aux3.txt aux4.txt aux6.txt
