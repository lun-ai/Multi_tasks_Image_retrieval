...
def create_field_index():
    train_key = 'Train'
    test_key = 'Test'
    field_index = {train_key:{'Iters':0, 'Seconds':1, train_key + ' Loss':2 ,train_key +' learning rate':3},
                              test_key:{'Iters':0, 'Seconds':1, test_key+' AccuracyAt1':2, test_key+' AccuracyAt5':3, test_key+' Loss':4}}
    fields = set()
