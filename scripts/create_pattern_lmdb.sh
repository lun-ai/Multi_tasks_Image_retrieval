...
TOOLS=build/tools
DATA=/home/cuiyan/lun/docomo_train_image_set/Pattern
TARGET=data_lmdb
...
rm -rf $TARGET/pattern_train_lmdb
rm -rf $TARGET/pattern_val_lmdb
rm -rf $TARGET/pattern_test_lmdb
