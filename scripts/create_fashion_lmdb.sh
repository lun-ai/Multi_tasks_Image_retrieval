...
TOOLS=build/tools
DATA=/home/cuiyan/lun/docomo_train_image_set/Type
TARGET=data_lmdb
...
rm -rf $TARGET/fashion_train_lmdb
rm -rf $TARGET/fashion_val_lmdb
rm -rf $TARGET/fashion_test_lmdb
